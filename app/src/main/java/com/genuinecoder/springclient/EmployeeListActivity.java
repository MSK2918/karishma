    ...
    employeeApi.getAllEmployees()
        .enqueue(new Callback<List<Employee>>() {
          ...
          public void onFailure(Call<List<Employee>> call, Throwable t) {
            Toast.makeText(EmployeeListActivity.this, "Failed to load students", Toast.LENGTH_SHORT).show();
          }
        });
  }
...
//  }
  ...
  private void populateListView(List<Employee> employeeList) {
    ...
    // Pass 'this' as the context and the employeeApi instance
    EmployeeAdapter employeeAdapter = new EmployeeAdapter(this, employeeList, employeeApi);
    recyclerView.setAdapter(employeeAdapter);
  }
